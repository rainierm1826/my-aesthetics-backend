...
Revision ID: 6934d7c9a1a9
Revises: 
Create Date: 2025-09-12 15:18:01.572711
...
def upgrade():
    ...
    sa.Column('discounted_price_snapshot', sa.Float(), nullable=False),
    sa.Column('branch_name_snapshot', sa.String(length=255), nullable=False),
    sa.Column('voucher_code_snapshot', sa.String(length=255), nullable=False),
    sa.Column('discount_amount', sa.Float(), nullable=False),
