...
Revision ID: 694f28fc8c7f
Revises: 
Create Date: 2025-09-13 14:38:18.986037
...
def upgrade():
    ...
    sa.Column('status', sa.Enum('cancelled', 'completed', 'on-process', 'waiting', name='appointment_status_enum'), nullable=False),
    sa.Column('isDeleted', sa.Boolean(), nullable=True),
